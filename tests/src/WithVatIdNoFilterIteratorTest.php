...
class WithVatIdNoFilterIteratorTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $sut = new WithVatIdNoFilterIterator($iterator, $field);
    ...
    {
        $sut = new WithVatIdNoFilterIterator($iterator);
