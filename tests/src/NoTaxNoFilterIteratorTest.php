...
use Germania\VatIdNo\Filters\WithoutTaxNoFilterIterator;
use Germania\VatIdNo\VatIdNoProviderInterface;

use Prophecy\Argument;

class WithoutTaxNoFilterIteratorTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $sut = new WithoutTaxNoFilterIterator($iterator, $field);
    ...
    {
        $sut = new WithoutTaxNoFilterIterator($iterator);
